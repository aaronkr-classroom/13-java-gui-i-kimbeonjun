...
public class Ex1402 {
	public static void main(String[] args) {
		...
		// 버튼 추가하기
		/*
		JButton btn1 = new JButton("One", new ImageIcon("Img/Icon2.png"));
		JButton btn2 = new JButton("Two", new ImageIcon("Img/Icon3.png"));
		JButton btn3 = new JButton("Three", new ImageIcon("Img/Icon4.png"));
		 */
		JButton btn1 = new JButton("One");
		JButton btn2 = new JButton("Two");
		JButton btn3 = new JButton("Three");
		btn1.setSize(64, 64); // 추후 다시 수정
		btn2.setSize(64, 64);
		btn3.setSize(64, 64);
		panel.add(btn1);
		panel.add(btn2);
